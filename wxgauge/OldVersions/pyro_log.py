...
def save_data(reading_num,a1,k1,a2,k2,time):
    file = open('/home/ed/Desktop/pyro_logger/log.txt', 'a')
    value_1 = "%.2f" % a1
    value_2 = "%.2f" % k1
    value_3 = "%.2f" % a2
    value_4 = "%.2f" % k2
...
if (os.path.exists('/home/ed/Desktop/pyro_logger/log.txt') & (graphing ==0)):
    print "Found Log text"
    print "Slurping Raw Data... ummmmmm!!!"
    current_sample = 1
    f = open('/home/ed/Desktop/pyro_logger/log.txt', 'r')
    for line in f.readlines():
        current_sample = current_sample + 1

elif (os.path.exists('/home/ed/Desktop/pyro_logger/log.txt') & (graphing ==1)):
    print "Found Log text"
    print "Slurping Raw Data... ummmmmm!!!"
    current_sample = 1
    thermo_front = []
